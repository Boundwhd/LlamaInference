#include "tensor.h"
#include <cuda_runtime.h>   //t提供高层次的接口来管理 GPU 设备、内存、核函数等
#include <numeric>          //提供数值计算方法

namespace tensor {
/**
 * @brief 计算一个范围（从 begin 到 end）内元素的乘积，并将结果与初始值 init 相乘
 */
...
/** 
 * @brief 将一个外部缓冲区分配给当前 Tensor 对象
 * 外部的buffer_size需要大于当前Tensor的byte_size
*/
